...
class ClientTransaction {
    ...
    async getIndices(homePageDocument) {
        ...
        if (!onDemandFileResponse.ok) {
            throw new errors_js_1.OnDemandFileFetchError(onDemandFileUrl, onDemandFileResponse.status, onDemandFileResponse.statusText);
        }
        ...
        if (!keyByteIndices.length) {
            throw new errors_js_1.KeyByteIndicesExtractionError();
        }
    ...
    getOnDemandFileUrl(response) {
        ...
        throw new errors_js_1.OnDemandFileUrlResolutionError();
    }
    /**
    ...
    getKey(response) {
        ...
        if (!content) {
            throw new errors_js_1.SiteVerificationKeyNotFoundError();
        }
        return content;
    }
    /**
    ...
    getAnimationKey(keyBytes, response) {
        ...
        if (this.DEFAULT_ROW_INDEX == null || this.DEFAULT_KEY_BYTES_INDICES == null) {
            throw new errors_js_1.IndicesNotInitializedError();
        }
        ...
        if (!arr || !arr[rowIndex]) {
            throw new errors_js_1.AnimationFrameDataError(rowIndex);
        }
    ...
    async generateTransactionId(method, path, response, key, animationKey, timeNow) {
        ...
        if (!this.isInitialized) {
            throw new errors_js_1.ClientTransactionNotInitializedError();
        }
